 ...
 */
public class NestedScrollView2 extends FrameLayout implements NestedScrollingParent3,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollView2 v, int scrollX, int scrollY,
    ...
    public NestedScrollView2(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public boolean onNestedFling(
        ...
        if (!consumed) {
            dispatchNestedFling(velocityX, 0, true);
            fling((int) velocityX);
            return true;
        }
        return false;
    ...
    protected float getBottomFadingEdgeStrength() {
        ...
        final NestedScrollView2.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        final int length = getVerticalFadingEdgeLength();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        * drag mode.
        */
        Log.d(TAG, "onInterceptTouchEvent2: "+mIsBeingDragged);
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overScrollByCompat(0, deltaY, 0, getScrollY(), range, 0, 0,
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((Math.abs(initialVelocitX) >= mMinimumVelocity)) {
                    if (!dispatchNestedPreFling(0, -initialVelocitX)) {
                        dispatchNestedFling(0, -initialVelocitX, true);
        ...
        if ((event.getSource() & InputDeviceCompat.SOURCE_CLASS_POINTER) != 0) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_SCROLL: {
                    if (!mIsBeingDragged) {
                        final float vscroll = event.getAxisValue(MotionEvent.AXIS_HSCROLL);
                        if (vscroll != 0) {
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            View child = getChildAt(0);
            NestedScrollView2.LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    public boolean pageScroll(int direction) {
        ...
        if (down) {
            ...
            if (count > 0) {
                ...
                NestedScrollView2.LayoutParams lp = (LayoutParams) view.getLayoutParams();
        ...
        if (nextFocused != null && isWithinDeltaOfScreen(nextFocused, maxJump, getWidth())) {
            ...
            if (direction == View.FOCUS_LEFT && getScrollX() < scrollDelta) {
                ...
                if (getChildCount() > 0) {
                    View child = getChildAt(0);
                    NestedScrollView2.LayoutParams lp = (LayoutParams) child.getLayoutParams();
                    int daBottom = child.getRight() + lp.rightMargin;
                    int screenBottom = getScrollX() + getWidth() - getPaddingRight();
            ...
            doScrollY(direction == View.FOCUS_RIGHT ? scrollDelta : -scrollDelta);
        }
   ...
   /**
    ...
    private void smoothScrollBy(int dx, int dy, int scrollDurationMs, boolean withNestedScrolling) {
        ...
        if (duration > ANIMATED_SCROLL_GAP) {
            ...
            final int maxX = Math.max(0, childSize - parentSpace);
            dx = Math.max(0, Math.min(scrollX + dx, maxX)) - scrollX;
            mScroller.startScroll(scrollX, getScrollY(), 0, dx, scrollDurationMs);
    ...
    public void computeScroll() {
        ...
        int unconsumed = x - mLastScrollerY;
        mLastScrollerY = x;
        ...
        if (unconsumed != 0) {
            ...
            overScrollByCompat(unconsumed, 0, oldScrollX, getScrollX(), range, 0, 0, 0, false);
            final int scrolledByMe = getScrollX() - oldScrollX;
            unconsumed -= scrolledByMe;

            // Nested Scrolling Post Pass
            mScrollConsumed[1] = 0;
            dispatchNestedScroll(0, scrolledByMe, unconsumed, 0, mScrollOffset,
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        View child = getChildAt(0);
        final NestedScrollView2.LayoutParams lp = (LayoutParams) child.getLayoutParams();
        if (rect.left < child.getWidth() + lp.leftMargin + lp.rightMargin) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!mIsLaidOut) {
            ...
            int parentSpace = r - l - getPaddingLeft() - getPaddingRight();
            int currentScrollX = getScrollX();
            int newScrollX = clamp(currentScrollX, parentSpace, childSize);
    ...
    public void draw(Canvas canvas) {
        ...
        if (mEdgeGlowTop != null) {
            ...
            if (!mEdgeGlowBottom.isFinished()) {
                ...
                int width = getWidth();
                int height = getHeight();
                int xTranslation = Math.max(getScrollRange(), scrollX) + width;
                int yTranslation = 0;
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP || getClipToPadding()) {
                    width -= getPaddingLeft() + getPaddingRight();
                    xTranslation += getPaddingLeft();
                ...
                canvas.translate(xTranslation, yTranslation- height);
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollView2 nsvHost = (NestedScrollView2) host;
            ...
            switch (action) {
                ...
                case android.R.id.accessibilityActionScrollRight: {
                    final int viewportHeight = nsvHost.getWidth() - nsvHost.getPaddingRight()
                            - nsvHost.getPaddingLeft();
                    final int targetScrollY = Math.min(nsvHost.getScrollX() + viewportHeight,
                            nsvHost.getScrollRange());
                    if (targetScrollY != nsvHost.getScrollX()) {
                        nsvHost.smoothScrollTo(targetScrollY, 0, true);
                        return true;
                    }
                }
                return false;
                ...
                case android.R.id.accessibilityActionScrollLeft: {
                    final int viewportHeight = nsvHost.getWidth() - nsvHost.getPaddingRight()
                            - nsvHost.getPaddingLeft();
                    final int targetScrollY = Math.max(nsvHost.getScrollX() - viewportHeight, 0);
                    if (targetScrollY != nsvHost.getScrollX()) {
                        nsvHost.smoothScrollTo(targetScrollY, 0, true);
                        return true;
                    }
